package mrcomputerghost.mods.evilforest.trees;
            ...
            else
            {
                ...
                if ((l1 == Block.grass.blockID || l1 == Block.dirt.blockID) && par4 < 128 - l - 1)
                {
                    ...
                    for (i2 = par4 + l; i2 >= par4 + i1; --i2)
                    {
                        for (j2 = par3 - l2; j2 <= par3 + l2; ++j2)
                        {
                            ...
                            for (int i3 = par5 - l2; i3 <= par5 + l2; ++i3)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, j2, i2, i3, Block.leaves.blockID, 0);
                                }
                            }
                        }
                    ...
                    for (i2 = 0; i2 < l - 1; ++i2)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + i2, par5, Block.wood.blockID, 0);
                        }
                    }
