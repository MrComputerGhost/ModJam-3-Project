...
public class EntityErieDX extends EntityFX
{
    ...
    public EntityErieDX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        this.particleRed = this.particleGreen = this.particleBlue = 3.0F * f;
