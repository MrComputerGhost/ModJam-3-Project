...
public class ForbiddenItems {
	...
	public static final EnumToolMaterial EnumToolParadox = EnumHelper
			.addToolMaterial("Paradox", 3, 2570, 10.0F, 4.5F, 35);
	// public static final EnumToolMaterial EnumToolStab =
	// EnumHelper.addToolMaterial("Paradox", 3, 2570, 6.0F, 4.5F, 50);
	public static final EnumArmorMaterial EnumArmorParadox = EnumHelper
			.addArmorMaterial("Paradox", 33, new int[] { 3, 8, 6, 3 }, 35);

	public static void initItems() {
		PureBark = new ItemPureBark(PureBarkDefaultID)
				.setUnlocalizedName("Pure Bark")
				.setTextureName("forbiddenlands:purebark")
		...
		Rider = new ItemRider(RiderDefaultID).setUnlocalizedName("Rider")
				.setTextureName("minecraft:lead")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(Rider, "Rider");
		LanguageRegistry.addName(Rider, "Rider");
		Stacker = new ItemStacker(StackerDefaultID).setUnlocalizedName(
				"Stacker").setTextureName("minecraft:lead");
		GameRegistry.registerItem(Stacker, "Stacker");
		LanguageRegistry.addName(Stacker, "Rider");
		PureBarkChunk = new ItemPureBarkChunk(PureBarkChunkDefaultID)
				.setUnlocalizedName("Pure Bark Chunk")
				.setTextureName("forbiddenlands:purebarkchunk")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(PureBarkChunk, "Pure Bark Chunk");
		LanguageRegistry.addName(PureBarkChunk, "Purified Bark Chunk");
		ParadoxDust = new ItemParadoxDust(ParadoxDustDefaultID)
				.setUnlocalizedName("Paradox Dust")
				.setTextureName("forbiddenlands:paradoxdust")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxDust, "Paradox Dust");
		LanguageRegistry.addName(ParadoxDust, "Paradox Dust");
		ParadoxCrystal = new ItemParadoxCrystal(ParadoxCrystalDefaultID)
				.setUnlocalizedName("Paradox Crystal")
				.setTextureName("forbiddenlands:paradoxcrystal")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxCrystal, "Paradox Crystal");
		LanguageRegistry.addName(ParadoxCrystal, "Paradox Crystal");
		ParadoxShard = new ItemParadoxShard(ParadoxShardDefaultID)
				.setUnlocalizedName("Paradox Shard")
				.setTextureName("forbiddenlands:paradoxshard")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxShard, "Paradox Shard");
		LanguageRegistry.addName(ParadoxShard, "Paradox Shard");
		ParadoxSword = new ItemParadoxSword(ParadoxSwordDefaultID,
				EnumToolParadox).setUnlocalizedName("Paradox Sword")
				.setTextureName("forbiddenlands:paradoxsword")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxSword, "Paradox Sword");
		LanguageRegistry.addName(ParadoxSword, "Paradox Sword");
		ParadoxPick = new ItemParadoxPick(ParadoxPickDefaultID, EnumToolParadox)
				.setUnlocalizedName("Paradox Pick")
				.setTextureName("forbiddenlands:paradoxpick")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxPick, "Paradox Pick");
		LanguageRegistry.addName(ParadoxPick, "Paradox Pick");
		ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
				new WeightedRandomChestContent(new ItemStack(ParadoxDust), 3,
						5, 25));
		ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
				new WeightedRandomChestContent(new ItemStack(ParadoxShard), 1,
						4, 20));
		ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
				new WeightedRandomChestContent(new ItemStack(ParadoxShard), 1,
						2, 10));
		ParadoxBow = new ItemParadoxBow(ParadoxBowDefaultID)
				.setUnlocalizedName("Paradox Bow")
				.setTextureName("forbiddenlands:bonebow")
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		GameRegistry.registerItem(ParadoxBow, "Paradox Bow");
		LanguageRegistry.addName(ParadoxBow, "Paradox Rocket");
		/**
		 * StabbbingKnife = new ItemStabbingKnife(StabbingKnifeDefaultID,
		 * EnumToolStab).setUnlocalizedName("Stabbing Knife").setTextureName(
		 * "forbiddenlands:StabbingKnife"
		 * ).setCreativeTab(ForbiddenLands.ForbiddenTab);
		 * GameRegistry.registerItem(StabbbingKnife, "Stabbing Knife");
		 * LanguageRegistry.addName(StabbbingKnife, "Stabbing Knife");
		 **/
		Debugger = new ItemDebugger(DebuggerDefaultID).setUnlocalizedName(
				"Debugger").setTextureName("minecraft:command");
		GameRegistry.registerItem(Debugger, "Debugger");
		LanguageRegistry.addName(Debugger, "Debugger");
		ParadoxStaff = new ItemParadoxStaff(ParadoxStaffDefaultID,
				EnumToolParadox).setUnlocalizedName("ParadoxStaff");
		GameRegistry.registerItem(ParadoxStaff, "ParadoxStaff");
		LanguageRegistry.addName(ParadoxStaff, "Paradox Staff");
		/*
		 * ParadoxHelm = (new ItemParadoxArmor(ParadoxHelmDefaultID,
		 * EnumArmorParadox,
		 * 0).setUnlocalizedName("Paradox Helm").setCreativeTab
		 * (ForbiddenLands.ForbiddenTab)); ParadoxChest = (new
		 * ItemParadoxArmor(ParadoxChestDefaultID, EnumArmorParadox,
		 * 1).setUnlocalizedName
		 * ("Paradox Chest").setCreativeTab(ForbiddenLands.ForbiddenTab));
		 * ParadoxLegs = (new ItemParadoxArmor(ParadoxLegsDefaultID,
		 * EnumArmorParadox,
		 * 2).setUnlocalizedName("Paradox Legs").setCreativeTab
		 * (ForbiddenLands.ForbiddenTab)); ParadoxBoots = (new
		 * ItemParadoxArmor(ParadoxBootsDefaultID, EnumArmorParadox,
		 * 3).setUnlocalizedName
		 * ("Paradox Boots").setCreativeTab(ForbiddenLands.ForbiddenTab));
