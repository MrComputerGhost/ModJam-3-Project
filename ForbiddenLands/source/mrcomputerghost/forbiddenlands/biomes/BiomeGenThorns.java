...
public class BiomeGenThorns extends BiomeGenBase {
	...
	public BiomeGenThorns(int par1) {
		...
		super(par1);
		this.topBlock = (byte) ForbiddenBlocks.DeadGrass.blockID;
		...
		this.spawnableMonsterList.add(new SpawnListEntry(
				EntityCaveSpider.class, 5, 4, 4));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityWitch.class, 5,
				4, 4));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityBat.class, 15,
				5, 5));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityEnderman.class,
				5, 4, 4));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityChicken.class,
				5, 5, 5));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityWither.class,
				(int) 0.5, 0, 1));
		this.theWorldGenerator = new WorldGenMinable(Block.silverfish.blockID,
				25);
		...
		this.theWorldGenerator = new WorldGenMinable(Block.oreEmerald.blockID,
				10);
	...
	public WorldGenerator getRandomWorldGenForTrees(Random par1Random) {
		if (!this.useOldThornBushes) {
			return (WorldGenerator) (par1Random.nextInt(3) == 0 ? new WorldGenEvilForest1(
					false) : new WorldGenEvilForest3(
					ForbiddenBlocks.ThornShrub.blockID));
		} else if (this.useOldThornBushes) {
			return (WorldGenerator) (par1Random.nextInt(3) == 0 ? new WorldGenEvilForest1(
					false) : new WorldGenEvilForest2(false));
		} else
			return null;
	}
	...
	public void decorate(World par1World, Random par2Random, int par3, int par4) {
		...
		if (par2Random.nextInt(42) == 0) {
			...
			worldgenevilwell.generate(par1World, par2Random, k,
		...
		if (par2Random.nextInt(16) == 2) {
			...
			worldgendungeons.generate(par1World, par2Random, k,
					par1World.getHeightValue(k, l) + 1, l);
		}
	}
}
