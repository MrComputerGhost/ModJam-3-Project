...
public class BiomeGenEnchantedForest extends BiomeGenBase {
	public BiomeGenEnchantedForest(int par1) {
		super(par1);
		this.topBlock = (byte)ForbiddenBlocks.EnchDirt.blockID;
		...
		this.spawnableCreatureList.add(new SpawnListEntry(EntityBat.class, 8,
				4, 8));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityZombie.class,
				2, 4, 8));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityCow.class, 5, 5,
				5));
		this.spawnableMonsterList.add(new SpawnListEntry(
				EntityCaveSpider.class, 1, 1, 1));
	}
