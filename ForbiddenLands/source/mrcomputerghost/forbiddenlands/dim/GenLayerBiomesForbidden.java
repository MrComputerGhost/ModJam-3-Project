...
public class GenLayerBiomesForbidden extends GenLayer {
	...
	protected BiomeGenBase[] allowedBiomes = { ForbiddenLands.EnchantedForest,
			ForbiddenLands.EnchantedForestHills, ForbiddenLands.ForbiddenHills,
			ForbiddenLands.Graveyard, ForbiddenLands.ForbiddenLandsBiome,
			ForbiddenLands.Wasted };
