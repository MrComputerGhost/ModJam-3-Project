...
{
this.worldChunkMgr = new WorldChunkManagerHell(ForbiddenLands.ForbiddenLandsBiome, this.dimensionId, this.dimensionId);
this.dimensionId = ForbiddenDimensions.dimID;
this.hasNoSky = true;
}
public IChunkProvider createChunkGenerator()
{
return new ChunkProviderForbidden(this.worldObj, this.worldObj.getSeed(), false);
}
...
{
if ((this instanceof WorldProviderForbidden))
{
