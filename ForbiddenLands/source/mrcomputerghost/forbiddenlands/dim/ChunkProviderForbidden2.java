...
public class ChunkProviderForbidden2 implements IChunkProvider {
	/** RNG. */
	private Random rand;
	...
	public ChunkProviderForbidden2(World world, long seed,
		...
		noiseGens = TerrainGen.getModdedNoiseGenerators(world, this.rand,
				noiseGens);
