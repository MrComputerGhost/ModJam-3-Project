...
public class WorldChunkMangerForbidden2 extends WorldChunkManager {
	...
	public WorldChunkMangerForbidden2(long seed, WorldType worldtype) {
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerForbidden.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkMangerForbidden2(World world) {
	...
	public float[] getTemperatures(float[] par1ArrayOfFloat, int par2,
		...
		for (int i1 = 0; i1 < par4 * par5; ++i1) {
			float f = (float) BiomeGenBase.biomeList[aint[i1]]
