...
public class ChunkProviderForbidden implements IChunkProvider {
	...
	private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2,
		...
		for (int var14 = 0; var14 < par5; var14++) {
			for (int var15 = 0; var15 < par7; var15++) {
				...
				float var18 = 0.0F;
				byte var19 = 2;
				BiomeGenBase var20 = this.biomesForGeneration[(var14 + 2 + (var15 + 2)
						* (par5 + 5))];
				for (int var21 = -var19; var21 <= var19; var21++) {
					for (int var22 = -var19; var22 <= var19; var22++) {
						BiomeGenBase var23 = this.biomesForGeneration[(var14
								+ var21 + 2 + (var15 + var22 + 2) * (par5 + 5))];
						float var24 = this.parabolicField[(var21 + 2 + (var22 + 2) * 5)]
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		for (int var12 = 0; var12 < 16; var12++) {
			for (int var13 = 0; var13 < 16; var13++) {
				int var14 = this.worldObj.getPrecipitationHeight(var4 + var12,
						var5 + var13);
	...
	public ChunkPosition findClosestStructure(World par1World, String par2Str,
		...
		return ("Stronghold".equals(par2Str))
				&& (this.strongholdGenerator != null) ? this.strongholdGenerator
