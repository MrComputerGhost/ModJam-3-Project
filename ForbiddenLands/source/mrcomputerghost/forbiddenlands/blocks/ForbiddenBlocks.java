...
public class ForbiddenBlocks {
	...
	public static Block GraveDirt;
	public static Block EnchDirt;
	...
	public static int GraveDirtDefaultID;
	public static int EnchDirtDefaultID;

	public static void initBlocks() {
		DeathWood = new BlockDeathWood(4042, "DeathWood")
				.setUnlocalizedName("DeathWood").setHardness(1.0F)
				.setStepSound(Block.soundWoodFootstep).setResistance(0.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		DeathLeaves = new BlockDeathLeaves(4043, "DeathLeaves")
				.setUnlocalizedName("DeathLeaves").setHardness(0.0F)
				.setStepSound(Block.soundPowderFootstep).setResistance(0.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		DeathPlanks = new BlockDeathPlanks(4044, "DeathPlanks")
				.setUnlocalizedName("DeathPlanks").setHardness(1.0F)
				.setStepSound(Block.soundWoodFootstep).setResistance(0.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		DeadGrass = new BlockDirts(4045).setUnlocalizedName("DeadGrass");
		ThornShrub = new BlockThornShrub(4046, "ThornShrub")
				.setUnlocalizedName("ThornShrub").setHardness(1.5F)
				.setStepSound(Block.soundLadderFootstep).setResistance(1.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		Thorns = new BlockThorns(4047, "Thorns").setUnlocalizedName("Thorns")
				.setHardness(0.5F).setStepSound(Block.soundLadderFootstep)
				.setResistance(1.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		CorruptedBark = new BlockCorruptedBark(4048, "CorruptedBark")
				.setUnlocalizedName("CorruptedBark").setHardness(0.7F)
				.setStepSound(Block.soundLadderFootstep).setResistance(0.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		FBPortal = new BlockFLPortal(4049).setUnlocalizedName("FBPortal")
				.setBlockUnbreakable().setStepSound(Block.soundGlassFootstep)
				.setResistance(10.0F).setCreativeTab(CreativeTabs.tabAllSearch);
		ParadoxFire = new BlockParadoxFire(4050)
				.setUnlocalizedName("ParadoxFire").setBlockUnbreakable()
				.setStepSound(Block.soundAnvilFootstep).setResistance(0.0F)
				.setCreativeTab(CreativeTabs.tabAllSearch);
		EnchBark = new BlockEnchantedBark(4051, "EnchBark")
				.setUnlocalizedName("EnchBark").setHardness(1.0F)
				.setStepSound(Block.soundPowderFootstep).setResistance(1.0F)
				.setCreativeTab(ForbiddenLands.ForbiddenTab);
		EnchPlanks = new BlockEnchPlanks(4052, "EnchPlanks")
				.setUnlocalizedName("EnchPlanks").setHardness(1.0F)
				.setStepSound(Block.soundAnvilFootstep).setResistance(1.0F)
				.setCreativeTab(CreativeTabs.tabDecorations);
		EnchLeaves = new BlockEnchLeaves(4053, "EnchLeaves")
				.setUnlocalizedName("EnchLeaves").setHardness(1.0F)
				.setStepSound(Block.soundAnvilFootstep).setResistance(1.0F)
				.setCreativeTab(CreativeTabs.tabDecorations);
		TombStone = new BlockTombStone(4054, false)
				.setUnlocalizedName("TombStone").setHardness(1.0F)
				.setStepSound(Block.soundAnvilFootstep).setResistance(1.0F)
				.setCreativeTab(CreativeTabs.tabDecorations)
				.setTextureName("forbiddenlands:grave");
		GraveDirt = new BlockDirts(4055).setUnlocalizedName("GraveDirt");
		EnchDirt = new BlockDirts(4056).setUnlocalizedName("EnchDirt");
		...
		GameRegistry.registerBlock(GraveDirt, "GraveDirt");
		GameRegistry.registerBlock(EnchDirt, "EnchDirt");
		...
		ChestGenHooks.getInfo(ChestGenHooks.BONUS_CHEST).addItem(
				new WeightedRandomChestContent(new ItemStack(
						ForbiddenBlocks.DeathPlanks), 1, 5, 25));
		ChestGenHooks.getInfo(ChestGenHooks.BONUS_CHEST).addItem(
				new WeightedRandomChestContent(new ItemStack(
						ForbiddenBlocks.DeathPlanks), 1, 5, 25));
