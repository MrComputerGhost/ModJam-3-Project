...
public class BlockThorns extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World,
		...
		byte b0 = 0;
		float f = 0.0625F;
		return AxisAlignedBB.getAABBPool().getAABB((double) par2 + this.minX,
				(double) par3 + this.minY, (double) par4 + this.minZ,
				(double) par2 + this.maxX,
				(double) ((float) par3 + (float) b0 * f),
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if (par5Random.nextInt(2) == 0) {
			par1World.spawnParticle("death_suspend",
