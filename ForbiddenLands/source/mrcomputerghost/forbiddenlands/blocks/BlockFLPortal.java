...
import mrcomputerghost.forbiddenlands.dim.ForbiddenTeleporter;
...
public class BlockFLPortal extends BlockBreakable
{
public BlockFLPortal(int par1)
{
...
byte b0 = 0;
byte b1 = 0;
if (par1World.getBlockId(par2 - 1, par3, par4) == ForbiddenBlocks.CorruptedBark.blockID || par1World.getBlockId(par2 + 1, par3, par4) == ForbiddenBlocks.CorruptedBark.blockID)
{
b0 = 1;
}
if (par1World.getBlockId(par2, par3, par4 - 1) == ForbiddenBlocks.CorruptedBark.blockID || par1World.getBlockId(par2, par3, par4 + 1) == ForbiddenBlocks.CorruptedBark.blockID)
{
b1 = 1;
}
if (b0 == b1)
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         if (flag)
         {
         if (j1 != ForbiddenBlocks.CorruptedBark.blockID)
         {
         return false;
         }
         }
...
if (par1World.getBlockId(par2, i1 - 1, par4) != ForbiddenBlocks.CorruptedBark.blockID)
{
...
if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == ForbiddenBlocks.CorruptedBark.blockID)
{
...
{
         if ((par1World.getBlockId(par2 + b0, par3, par4 + b1) != ForbiddenBlocks.CorruptedBark.blockID || par1World.getBlockId(par2 - b0, par3, par4 - b1) != this.blockID) && (par1World.getBlockId(par2 - b0, par3, par4 - b1) != ForbiddenBlocks.CorruptedBark.blockID || par1World.getBlockId(par2 + b0, par3, par4 + b1) != this.blockID))
         {
         par1World.setBlockToAir(par2, par3, par4);
         }
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != ForbiddenDimensions.dimID)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ForbiddenDimensions.dimID, new ForbiddenTeleporter(thePlayer.mcServer.worldServerForDimension(ForbiddenDimensions.dimID)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
