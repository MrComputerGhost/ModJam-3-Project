...
public class BlockThornShrub extends Block {
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if (par5Random.nextInt(2) == 0) {
			par1World.spawnParticle("thorn_shrub",
					par2 + par5Random.nextFloat(), par3 + 1.1F, par4
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister
				.registerIcon("forbiddenlands:thorn_shrub");
	}
	...
	public static class DamageThornShrub extends DamageSource {
		...
		public ChatMessageComponent getDeathMessage(
			...
			return ChatMessageComponent
					.createFromText(Minecraft.getMinecraft().thePlayer.username
							+ " "
							+ StatCollector.translateToLocal("death.message"
									+ sel));
		}
	}
