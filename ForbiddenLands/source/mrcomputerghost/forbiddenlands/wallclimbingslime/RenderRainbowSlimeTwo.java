...
public class RenderRainbowSlimeTwo extends RenderLiving
{
    private static final ResourceLocation slimeTextures = new ResourceLocation("glowglass", "textures/entity/rainbowslime/RainbowSlime.png");
    private ModelBase scaleAmount;

    public RenderRainbowSlimeTwo(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3)
    {
    ...
    protected ResourceLocation getSlimeTextures(EntityRainbowSlime par1EntitySlime)
    {
    ...
    {
        return this.getSlimeTextures((EntityRainbowSlime)par1Entity);
    }
}
