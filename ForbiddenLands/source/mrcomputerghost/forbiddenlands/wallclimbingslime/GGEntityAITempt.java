...
public class GGEntityAITempt extends EntityAIBase
{
    /** The entity using this AI that is tempted by the player. */
    private EntityRainbowSlime temptedEntity;
    ...
    public GGEntityAITempt(EntityRainbowSlime par1EntityRS, double par2, int par4, boolean par5)
    {
        this.temptedEntity = par1EntityRS;
