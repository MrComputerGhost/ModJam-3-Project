...
import mrcomputerghost.forbiddenlands.worldgen.WorldGenEvilForest2;
...
public class ChunkProviderForbidden implements IChunkProvider {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		//Enchanted Trees
        for (int c = 1024; c > 0; c--)
        {
                int j2 = k + rand.nextInt(16) + 8;
                int l3 = rand.nextInt(120);
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID) && ((worldObj.getBiomeGenForCoords(j2, j5) == ForbiddenLands.EnchantedForest) || (worldObj.getBiomeGenForCoords(j2, j5) == ForbiddenLands.EnchantedForestHills)))
                {
                    new WorldGenEnchTree(false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        //Thorns
        for (int c = 1024; c > 0; c--)
        ...
        for (int c = 1024; c > 0; c--)
        {
                ...
                int l3 = rand.nextInt(120);
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID) && (worldObj.getBiomeGenForCoords(j2, j5) == ForbiddenLands.Graveyard))
                {
                        new WorldGenGrave().generate(worldObj, rand, j2, l3, j5);
                }
        }
        
        //Evil Trees
        for (int c = 42809; c > 0; c--)
        {
                int j2 = k + rand.nextInt(16) + 8;
                int l3 = rand.nextInt(120);
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID) && ((worldObj.getBiomeGenForCoords(j2, j5) == ForbiddenLands.ForbiddenHills) || (worldObj.getBiomeGenForCoords(j2, j5) == ForbiddenLands.ThornForest) || (worldObj.getBiomeGenForCoords(j2, j5) == (ForbiddenLands.ForbiddenLandsBiome))))
                {
                        new WorldGenEvilForest1().generate(worldObj, rand, j2, l3, j5);
                }
        }
        //Evil Well
        for (int c = 256; c > 0; c--)
