...
public class WorldGenEnchTree extends WorldGenerator implements IWorldGenerator {
		...
		if (par4 >= 1 && par4 + l + 1 <= 256) {
			...
			if (!flag) {
				...
				boolean isValidSoil = soil != null
						&& soil.canSustainPlant(par1World, par3, par4 - 1,
								par5, ForgeDirection.UP,
					...
					for (i2 = par4 - 3 + l; i2 <= par4 + l; ++i2) {
						...
						for (l1 = par3 - k1; l1 <= par3 + k1; ++l1) {
							...
							for (int k2 = par5 - k1; k2 <= par5 + k1; ++k2) {
								...
								if (Math.abs(j2) != k1 || Math.abs(l2) != k1
									...
									if (block == null
										...
										this.setBlockAndMetadata(
												...
												i2,
												k2,
												ForbiddenBlocks.EnchLeaves.blockID,
												2);
									}
								}
							}
