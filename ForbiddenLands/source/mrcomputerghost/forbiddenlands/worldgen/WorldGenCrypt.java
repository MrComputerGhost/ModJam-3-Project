...
public class WorldGenCrypt extends WorldGenerator implements IWorldGenerator {
	protected int[] GetValidSpawnBlocks() {
		return new int[] { Block.mycelium.blockID, Block.stone.blockID,
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		if (!LocationIsValidSpawn(world, i, j, k)
				...
				|| !LocationIsValidSpawn(world, i + 6, j, k + 6)
				|| !LocationIsValidSpawn(world, i, j, k + 6)) {
			return false;
		}
		...
		world.setBlock(i + 2, j + 0, k + 0, Block.stairsCobblestone.blockID, 2,
				2);
		...
		world.setBlock(i + 2, j + 0, k + 6, Block.stairsCobblestone.blockID, 3,
				3);
		world.setBlock(i + 2, j + 1, k + 1, Block.stairsStoneBrick.blockID, 2,
				2);
		...
		world.setBlock(i + 2, j + 1, k + 5, Block.stairsStoneBrick.blockID, 3,
				3);
		...
		world.setBlock(i + 3, j + 0, k + 0, Block.stairsCobblestone.blockID, 2,
				2);
		...
		world.setBlock(i + 3, j + 0, k + 6, Block.stairsStoneBrick.blockID, 3,
				3);
		world.setBlock(i + 3, j + 1, k + 1, Block.stairsCobblestone.blockID, 2,
				2);
		...
		TileEntityChest tileentitychest = (TileEntityChest) world
				.getBlockTileEntity(i + 3, j + 1, k + 3);
		...
		world.setBlock(i + 3, j + 1, k + 5, Block.stairsCobblestone.blockID, 3,
				3);
		world.setBlock(i + 3, j + 2, k + 2, Block.stoneSingleSlab.blockID);
		world.setBlock(i + 3, j + 2, k + 3, Block.silverfish.blockID, 2, 2);
		world.setBlock(i + 3, j + 3, k + 3, ForbiddenBlocks.TombStone.blockID,
				2, 2);
		world.setBlock(i + 3, j + 2, k + 4, Block.stoneSingleSlab.blockID);
		world.setBlock(i + 3, j + 5, k + 2, Block.stairsCobblestone.blockID, 2,
				2);
		world.setBlock(i + 3, j + 5, k + 3, Block.silverfish.blockID, 1, 1);
		world.setBlock(i + 3, j + 5, k + 4, Block.stairsCobblestone.blockID, 3,
				3);
		world.setBlock(i + 4, j + 0, k + 0, Block.stairsStoneBrick.blockID, 2,
				2);
		...
		world.setBlock(i + 4, j + 0, k + 6, Block.stairsCobblestone.blockID, 3,
				3);
		world.setBlock(i + 4, j + 1, k + 1, Block.stairsStoneBrick.blockID, 2,
				2);
		...
		world.setBlock(i + 4, j + 1, k + 5, Block.stairsCobblestone.blockID, 3,
				3);
		...
		world.setBlock(i + 4, j + 5, k + 3, Block.stairsCobblestone.blockID, 1,
				1);
		...
		world.setBlock(i + 5, j + 1, k + 2, Block.stairsCobblestone.blockID, 1,
				1);
		world.setBlock(i + 5, j + 1, k + 3, Block.stairsStoneBrick.blockID, 1,
				1);
		world.setBlock(i + 5, j + 1, k + 4, Block.stairsStoneBrick.blockID, 1,
				1);
		...
		world.setBlock(i + 6, j + 0, k + 2, Block.stairsCobblestone.blockID, 1,
				1);
		world.setBlock(i + 6, j + 0, k + 3, Block.stairsCobblestone.blockID, 1,
				1);
		world.setBlock(i + 6, j + 0, k + 4, Block.stairsStoneBrick.blockID, 1,
				1);
