...
public class WorldGenEvilForest3 extends WorldGenerator implements
		IWorldGenerator {
	...
	public boolean generate(World par1World, Random par2Random, int par3,
		...
		if ((i2 == Block.dirt.blockID || i2 == ForbiddenBlocks.DeadGrass.blockID)) {
			for (int i1 = 0; i1 < 4; ++i1) {
				...
				if ((!par1World.isAirBlock(j1, k1, l1))
						&& par1World.isAirBlock(j1, k1 + 1, l1)
						&& Block.blocksList[ForbiddenBlocks.ThornShrub.blockID].canBlockStay(
								par1World, j1, k1, l1)) {
					par1World.setBlock(j1, k1 + 1, l1, ForbiddenBlocks.ThornShrub.blockID, 1, 0);
				}
			}
		}
		return true;
