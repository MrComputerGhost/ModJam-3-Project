...
public class TileEntityTombStoneRenderer extends TileEntitySpecialRenderer {
	...
	public final ModelTombStone model;

	public TileEntityTombStoneRenderer() {

		model = new ModelTombStone();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if (tileentity.getBlockType() == ForbiddenBlocks.TombStone) {
			Minecraft.getMinecraft().renderEngine
					.bindTexture(Textures.TOMBSTONE_TEXTURE);
		}

		/**
		 * else if (tileentity.getBlockType() == ForbiddenBlocks.TombStone) {
